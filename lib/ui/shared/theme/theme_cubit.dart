  ...
  static ThemeData _buildLightTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.light(
        ...
        secondary: Colors.white, // Example secondary color
        onSecondary: Colors.black, // Text color on the secondary color
        ...
        surface: Colors.grey.shade200, // Surface color
  ...
  static ThemeData _buildDarkTheme() {
    return ThemeData(
        ...
        colorScheme: ColorScheme.dark(
          ...
          surface: Colors.grey.shade900, // Surface color for dark theme
